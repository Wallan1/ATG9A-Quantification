...
```{r}
subsetCT<-combwTidy[combwTidy$Type == "Control" | combwTidy$Type == "tepsin",]

subsetUC<-subsetCT[subsetCT$Rescue == "unt" | subsetCT$Rescue == "Cterm",]
...
plotme<-function(dat,yaxis,labelme,mytitle){
   ...
   stat_boxplot(geom = "errorbar", width = 0.4, position = position_dodge(width = 0.9)) +
    geom_boxplot_pattern(
    aes(),width=0.7,position = position_dodge(0.95), stat= "boxplot", outlier.shape=NA, alpha=0.5,
            pattern_spacing = 0.1,
            pattern_fill = "black",
            pattern_angle = 25,
            pattern_density = 0.1,) + 
...
#tiff(file="./rescue-analysis_22May22/graphs/May-2023/corrected-datasets_June2023/percGolATG9A_NSW4046-4048-4049_CT_adjY0-100_5Jun23.tiff",width=2500,height=5000,res=600)
#plotme(temp,temp$PercGolATG9, "percent ATG9A in TGN","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/MOC_NSW4046-4048-4049_adjY-CT_5Jun23.tiff",width=2500,height=5000,res=600)
#plotme(temp,temp$MandersMOC, "Manders Overlap Coefficient","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/M1_NSW4046-4048-4049_adjY-CT_5Jun23.tiff",width=2500,height=5000,res=600)
#plotme(temp,temp$MandersM1, "M1: ATG9 in TGN","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/M2_NSW4046-4048-4049_adjY-CT_5Jun23.tiff",width=2500,height=5000,res=600)
#plotme(temp,temp$MandersM2, "M2: TGN in ATG9","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/PCC-ATG9A_NSW4046-4048-4049_adjY-CT_5Jun23.tiff",width=2500,height=5000,res=600)
...
boxplots without Type facet wrap- Windows save file pathing
*filepathing is written for Windows*
#rename graphing file to temp based on which subset of data is desired
#made own code chunk because a lot of graphing elements need adjustment
```{r}
temp$Type<-factor(temp$Type, levels=c("WT", "Control", "tepsin", "AP4E1"))
temp$Rescue<-factor(temp$Rescue, levels=c("unt", "WTtep", "LIRless", "Cterm"))
...
plotme<-function(dat,yaxis,labelme,mytitle){
   ggplot(dat,aes(x=Type,y=yaxis,fill=Type, pattern=Rescue)) + 
      #geom_boxplot(width=.7,position = position_dodge(0.9),alpha=0.5, outlier.shape = 20, outlier.size = -1) +
    #geom_jitter(position = position_jitterdodge(1.4),alpha=.6, color = "grey") +
    geom_jitter(position = position_jitterdodge(jitter.width=0.35, dodge.width=0.9),  alpha=0.8, color= "dark grey") +
   stat_boxplot(geom = "errorbar", width = 0.5, position = position_dodge(width = 0.9)) +
    geom_boxplot_pattern(
    aes(),width=0.7,position = position_dodge(0.9), stat= "boxplot", outlier.shape=NA, alpha=0.5,
...
tiff(file="./rescue-analysis_22May22/graphs/May-2023/corrected-datasets_June2023/percGolATG9A_NSW4046-4048-4049_CT_noFacet_adjY0-100_5Jun23.tiff",width=4000,height=4000,res=600)
plotme(temp,temp$PercGolATG9, "percent ATG9A in TGN","")
dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/MOC_noFacet_NSW4046-4048-4049_adjY-CT_5Jun23.tiff",width=2500,height=2500,res=600)
#plotme(temp,temp$MandersMOC, "Manders Overlap Coefficient","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/PCC-ATG9A_noFacet_NSW4046-4048-4049_adjY-CT_5Jun23.tiff",width=2500,height=2500,res=600)
#plotme(temp,temp$PearsonCoeff, "Pearson's correlation coefficient","ATG9A co-localization with TGN")
#dev.off()
