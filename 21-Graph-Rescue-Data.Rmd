...
plotme<-function(dat,yaxis,labelme,mytitle){
   ggplot(dat,aes(x=Type,y=yaxis,fill=Type, pattern=Rescue)) + 
    ...
    aes(),width=0.7,position = position_dodge(0.9),outlier.shape=NA, alpha=0.5,
     ...
     ggtitle(mytitle)+
     theme_minimal()+
     #scale_y_continuous(name=labelme,limits = c(0,8.0))+
...
#tiff(file="./rescue-analysis_22May22/graphs/nonGolATG9Vol_NSW4039A_22May22.tiff",width=5000,height=10000,res=600)
...
#tiff(file="./rescue-analysis_22May22/graphs/nonGolATG9MaxInt_violin-box_NSW4039A_22May22.tiff",width=8000,height=10000,res=600)
#plotme(temp, temp$nonGolATG9MaxInt, "fluorescence intensity (a.u.)","non-Golgi ATG9A Max Intensity")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/GolATG9MaxInt_violin-box_NSW4039A_22May22.tiff",width=8000,height=10000,res=600)
#plotme(temp, temp$GolATG9MaxInt, "fluorescence intensity (a.u.)","Golgi ATG9A Max Intensity")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/nonGolATG9MaxInt_hist_NSW4020-4022_2000-4000_v2_15Feb22.tiff",width=3000,height=3000,res=600)
...
>>>>>>> d16a5a6241798a288003431640ae130c478edea6
