...
plotme<-function(dat,yaxis,labelme,mytitle){
   ggplot(dat,aes(x=Type,y=yaxis,fill=Type, pattern=Rescue)) + 
    ...
    facet_wrap(~Rescue)+
    geom_jitter(position = position_jitterdodge(.65), alpha=0.8, color= "dark grey") +
   stat_boxplot(geom = "errorbar", width = 0.4, position = position_dodge(width = 0.9)) +
    ...
    aes(),width=0.7,position = position_dodge(0.9), stat= "boxplot", outlier.shape=NA, alpha=0.5,
     ...
     ggtitle(mytitle)+
     theme_minimal()+
  scale_y_continuous(name=labelme,limits = c(0.26, 0.84))+
...
#tiff(file="./rescue-analysis_22May22/graphs/May-2023/percGolATG9A_NSW4046-4048-4049_CT_adjY0-100_23May23.tiff",width=3000,height=5000,res=600)
#plotme(temp,temp$PercGolATG9, "percent ATG9A in TGN","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/MOC_NSW4046-4048-4049_adjY-CT_23May23.tiff",width=3000,height=5000,res=600)
plotme(temp,temp$MandersMOC, "Manders Overlap Coefficient","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/M1_NSW4046-4048-4049_adjY-CT_23May23.tiff",width=3000,height=5000,res=600)
#plotme(temp,temp$MandersM1, "M1: ATG9 in TGN","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/M2_NSW4046-4048-4049_adjY-CT_23May23.tiff",width=3000,height=5000,res=600)
#plotme(temp,temp$MandersM2, "M2: TGN in ATG9","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/May-2023/PCC-ATG9A_NSW4046-4048-4049_CT_23May23.tiff",width=3000,height=5000,res=600)
