...
#tiff(file="./rescue-analysis_22May22/graphs/MOC_NSW4039A_adjY_2Jun22.tiff",width=3000,height=5000,res=600)
#plotme(temp,temp$MandersMOC, "Manders Overlap Coefficient","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/M1_NSW4039A_adjY_2Jun22.tiff",width=3000,height=5000,res=600)
...
#tiff(file="./rescue-analysis_22May22/graphs/nonGolATG9Vol_NSW4039A_0-15_3Jun22.tiff",width=3000,height=5000,res=600)
...
#tiff(file="./rescue-analysis_22May22/graphs/nonGolATG9MaxInt_violin-box_NSW4039A_3Jun22.tiff",width=10000,height=8000,res=600)
#plotme(temp, temp$nonGolATG9MaxInt, "fluorescence intensity (a.u.)","non-Golgi ATG9A Max Intensity")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/GolATG9MaxInt_violin-box_NSW4039A_2Jun22.tiff",width=10000,height=8000,res=600)
