...
plotme<-function(dat,yaxis,labelme,mytitle){
   ggplot(dat,aes(x=Type,y=yaxis,fill=Type, pattern=Rescue)) + 
    ...
    aes(),width=0.7,position = position_dodge(0.9),outlier.shape=NA, alpha=0.5,
     ...
     ggtitle(mytitle)+
     theme_minimal()+
     #scale_y_continuous(name=labelme,limits = c(0,10))+
...
#tiff(file="./rescue-analysis_22May22/graphs/MOC_NSW4046_130-myc_yadj_5Sep22.tiff",width=3000,height=5000,res=600)
#plotme(temp,temp$MandersMOC, "Manders Overlap Coefficient","")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/M1_NSW4046_130-myc_yadj_5Sep22.tiff",width=3000,height=5000,res=600)
...
#tiff(file="./rescue-analysis_22May22/graphs/nonGolATG9Vol_0-10_NSW4046_5Sep22.tiff",width=3000,height=5000,res=600)
...
#tiff(file="./rescue-analysis_22May22/graphs/nonGolATG9MaxInt_violin-box_NSW4046_5Sep22.tiff",width=10000,height=8000,res=600)
#plotme(temp, temp$nonGolATG9MaxInt, "fluorescence intensity (a.u.)","non-Golgi ATG9A Max Intensity")
#dev.off()

#tiff(file="./rescue-analysis_22May22/graphs/GolATG9MaxInt_violin-box_NSW4046_5Sep22.tiff",width=10000,height=8000,res=600)
