...
plotme<-function(dat,yaxis,labelme,mytitle){
   ggplot(dat,aes(x=Type,y=yaxis,fill=Type, pattern=Rescue)) + 
    ...
    aes(),width=0.7,position = position_dodge(0.9),outlier.shape=NA, alpha=0.5,
     ...
     ggtitle(mytitle)+
     theme_minimal()+
     scale_y_continuous(name=labelme,limits = c(0,50))+
...
#tiff(file="./rescue-analysis_22May22/graphs/nonGolATG9Vol_0-50_NSW4039-4040-4041_14Jul22.tiff",width=3000,height=5000,res=600)
