...
plotme<-function(dat,yaxis,labelme,mytitle){
   ggplot(dat,aes(x=Type,y=yaxis,fill=Type, pattern=Rescue)) + 
    ...
    aes(),width=0.7,position = position_dodge(095),outlier.shape=NA, alpha=0.5,
            pattern_spacing = 0.1,
            pattern_fill = "black",
            pattern_angle = 25,
            pattern_density = 0.1,) + 
...
tiff(file="./rescue-analysis_22May22/graphs/MOC_NSW4046-4048-4049_adjY-CT-UC_20Nov22.tiff",width=2500,height=2500,res=600)
