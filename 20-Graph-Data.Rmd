...
```{r}
subsetCTA<-temp[temp$Type == "Control" | temp$Type == "tepsin" | temp$Type == "AP4E1",]
...
#tiff(file="./graphs/MOC_NSW4019_3Mar22.tiff",width=2000,height=3000,res=600)
plotme(temp,temp$MandersMOC, "Manders Overlap Coefficient","")
#dev.off()

#tiff(file="./graphs/M1_NSW4019_3Mar22.tiff",width=1800,height=2500,res=600)
plotme(temp,temp$MandersM1, "M1: ATG9 in TGN","")
#dev.off()

#tiff(file="./graphs/M2_NSW4019_3Mar22.tiff",width=1800,height=2500,res=600)
plotme(temp,temp$MandersM2, "M2: TGN in ATG9","")
#dev.off()

#tiff(file="./graphs/PCC-ATG9A_NSW4019_3Mar22.tiff",width=2000,height=3000,res=600)
plotme(temp,temp$PearsonCoeff, "Pearson's correlation coefficient","ATG9A co-localization with TGN")
#dev.off()

#tiff(file="./graphs/nonGolATG9Vol_NSW4019_3Mar22.tiff",width=1800,height=2500,res=600)
plotme(temp,temp$nonGolATG9Vol, "object volume","non-Golgi ATG9A volume")
#dev.off()

#tiff(file="./graphs/nonGolATG9MaxInt_NSW4019_3Mar22.tiff",width=2000,height=3000,res=600)
plotme(temp,temp$nonGolATG9MaxInt, "fluorescence intensity","non-Golgi ATG9A Max Intensity")
#dev.off()

#tiff(file="./graphs/GolATG9MaxInt_NSW4019_3Mar22.tiff",width=2000,height=3000,res=600)
...
plotme<-function(dat,yaxis,labelme,mytitle){
    ...
    geom_violin(scale="count", width= 1.15, color="#424949", alpha=0.5) +
...
#tiff(file="./graphs/nonGolATG9MaxInt_violin-box_NSW4019_3Mar22.tiff",width=3000,height=2500,res=600)
plotme(temp, temp$nonGolATG9MaxInt, "fluorescence intensity (a.u.)","non-Golgi ATG9A Max Intensity")
#dev.off()

#tiff(file="./graphs/GolATG9MaxInt_violin-box_NSW4019_3Mar22.tiff",width=3000,height=2500,res=600)
