...
plotme<-function(dat,xaxis,labelme,mytitle){
  
    ggplot(dat,aes(x=xaxis,fill=Type)) +
    geom_histogram(color="#424949", binwidth=100, alpha=0.5) +
    facet_wrap(~Type)+
...
plotme<-function(dat,yaxis,labelme,mytitle){
    ...
    geom_violin(scale="count", width= 1.25, color="#424949", alpha=0.5) +
    #facet_wrap(~Type)+
...
#tiff(file="./graphs/nonGolATG9MaxInt_violin_NSW4020-4022_18Feb22.tiff",width=3000,height=2000,res=600)
plotme(temp,temp$nonGolATG9MaxInt, "fluorescence intensity (a.u.)","non-Golgi ATG9A Max Intensity")
#dev.off()
