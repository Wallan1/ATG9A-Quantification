...
#tiff(file="./graphs/percGolATG9A_NSW4019_7Jan22.tiff",width=2000,height=3000,res=600)
plotme(temp,temp$PercGolATG9, "percent ATG9A in TGN","")
#dev.off()

#tiff(file="./graphs/M1_NSW4019_7Jan22.tiff",width=2000,height=3000,res=600)
plotme(temp,temp$MandersM1, "M1: ATG9 in TGN","")
#dev.off()

#tiff(file="./graphs/M2_NSW4019_7Jan22.tiff",width=2000,height=3000,res=600)
plotme(temp,temp$MandersM2, "M2: TGN in ATG9","")
#dev.off()

#tiff(file="./graphs/PCC-ATG9A_NSW4019_0-1scale_13Jan22.tiff",width=2000,height=3000,res=600)
plotme(temp,temp$PearsonCoeff, "Pearson's correlation coefficient","ATG9A co-localization with TGN")
#dev.off()

#tiff(file="./graphs/PCC-ATG9A_NSW4019_0-1scale_13Jan22.tiff",width=2000,height=3000,res=600)
plotme(temp,temp$non, "Pearson's correlation coefficient","ATG9A co-localization with TGN")
#dev.off()
